...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <!-- <link rel="stylesheet" id="css-theme" href="<?php echo base_url() ?>template/css/themes/flat.min.css"> -->
        <!-- END Stylesheets -->
    </head>
    <body>
        <!-- Error Content -->
        ...
        <div class="content pulldown text-muted text-center">
            ...
            <a class="link-effect" href="javascript:void(0)">Report it</a> or <a class="link-effect" href="index.html">Go Back to Dashboard</a>
        </div>
        <!-- END Error Footer -->
