<div class="content content-narrow">
    <ol class="breadcrumb push-15">
        <li><a class="text-muted forum" href="javascript:void()" onclick="forum_page()">Forums</a></li>
        <li><a class="link-effect" href="javascript:void()" onclick="window.location.reload()"><?php echo $topic; ?></a></li>
    </ol>
            ...
            <table class="table table-striped table-borderless">
                ...
                <?php } ?>
                    <tr id="forum-reply-form">
                        <td class="hidden-xs"></td>
                        <td class="font-s13 text-muted">
                            <span class="text-primary"><?php echo $nama_dos ?></span> Just now
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>                        
                            ...
                            <input type="hidden" name="id_detail_forum" id="id_detail_forum" value="<?php echo $detail_forum ?>" />
...
<script type="text/javascript">
    ...
    function save()
    {
        ...
        url = "<?php echo site_url('forum/ajax_save')?>";
